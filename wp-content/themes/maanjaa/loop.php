<?php
	...
	$cat_output = '';
    $cat_output .= '<a href="' . esc_url( get_category_link( $category[0]->term_id ) ) . '" title="' . esc_attr( sprintf( __( 'View all posts in %s', 'maanjaa' ), $category[0]->name ) ) . '"><span class="category">' . esc_attr( $category[0]->name ) . '</span></a>';
...
<div class="col-md-<?php if( get_theme_mod('blog_sidebar', true) == true ) {echo '8';} else {echo '12';} ?>">
	...
	<p><?php esc_attr_e('No more posts.', 'maanjaa' ); ?></p>
