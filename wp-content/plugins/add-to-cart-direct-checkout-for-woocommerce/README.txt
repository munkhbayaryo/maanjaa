...
* You can set **custom thank you page redirect url for each product**, so when user purchases those product they get redirected to there respective thank you page
...
you have the option to specify the Weight of the link in the product page, so when there are 2 product with different thank you page then there wright is considered and the product with highest weight is used for the redirect