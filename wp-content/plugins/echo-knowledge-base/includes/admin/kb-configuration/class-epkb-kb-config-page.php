...
class EPKB_KB_Config_Page {
	...
	private function mega_menu_kb_templates() {
        ...
        echo '<p><a href="http://www.echoknowledgebase.com/documentation/current-theme-vs-kb-theme/" target="_blank" class="eckb-external-link">' . __( 'More about templates', 'echo-knowledge-base' ) . '</a>';
