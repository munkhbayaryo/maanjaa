	...
	public static function get_fields_specification( $kb_id ) {
		...
		$config_specification = array(
			...
			'meta-data-footer-toggle' => array(
				'label'       => __( 'Enable Footer Meta Data', 'echo-knowledge-base' ),
			...
			'article_toc_scroll_offset' => array(
                'label'       => __( 'Offset from Top (px)', 'echo-knowledge-base' ),
			...
			/******   OTHER   ******/
			'last_udpated_on_header_toggle' => array(
				'label'       => __( 'Show Last Update On', 'echo-knowledge-base' ),
				'name'        => 'last_udpated_on_header_toggle',
				'type'        => EPKB_Input_Filter::CHECKBOX,
				'default'     => 'on'
			),
			...
			'last_udpated_on_text' => array(
				'label'       => __( 'Last Updated Text', 'echo-knowledge-base' ),
			...
			'created_on_header_toggle' => array(
				'label'       => __( 'Show Created On', 'echo-knowledge-base' ),
				'name'        => 'created_on_header_toggle',
				'type'        => EPKB_Input_Filter::CHECKBOX,
				'default'     => 'on'
			),
			...
			'created_on_text' => array(
				'label'       => __( 'Created On Text', 'echo-knowledge-base' ),
			...
			'author_header_toggle' => array(
				'label'       => __( 'Show Author', 'echo-knowledge-base' ),
				'name'        => 'author_header_toggle',
				'type'        => EPKB_Input_Filter::CHECKBOX,
				'default'     => 'on'
			),
